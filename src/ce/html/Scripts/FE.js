...
function FE(name_tmp, renderer)
{
    ...
    this.FEicon = '/Images/fe_supermicro1.png';
...
FE.prototype.requestDataGauge = function(data, gauge_index)
{
    if (!this.stopUpdates)
    {
        var feObject = this;
...
FE.prototype.draw = function()
{
    ...
    {
        this.form.push(this.renderer.path(['M', this.FEx + this.FEboxwidth / 2 + 10 * (i - this.no_conn / 2), this.FEy,
...
FE.prototype.standby = function()
{
    ...
    this.minichart[0].series[0].points[0].update(0);
...
FE.prototype.wakeup = function()
{
    ...
    this.minichart[0].yAxis[0].update(gauge1_yAxes_opt);
    //this.minichart[0].pane[0].update(gauge1_pane_opt);
};
