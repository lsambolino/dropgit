...
#include <arpa/inet.h> /* tnt::network_to_host */
...
char* version = "$Id: pingd.c 11283 2012-06-11 12:37:17Z luigi $";
...
is_icmp(char* pkt)
{
    ...
    if (tnt::network_to_host(eh->ether_type) != ETHERTYPE_IP ||
            ip->ip_p != 1 ||
