...
#ifndef CPPREST_BASE_URI_H_
#define CPPREST_BASE_URI_H_
...
/// </summary>
struct uri_exception : public std::runtime_error
{
    uri_exception(const std::string& msg) : std::runtime_error(msg) {}
};
...
public:
    ...
    _ASYNCRTIMP static utility::string_t  encode_uri(const utility::string_t &raw, uri::components::component = components::full_uri);
    ...
    /// <returns>The encoded string.</returns>
    _ASYNCRTIMP static utility::string_t  encode_data_string(const utility::string_t &utf8data);
    ...
    _ASYNCRTIMP static utility::string_t  decode(const utility::string_t &encoded);
...
#pragma region splitting
    ...
    _ASYNCRTIMP static std::vector<utility::string_t>  split_path(const utility::string_t &path);
    ...
    _ASYNCRTIMP static std::map<utility::string_t, utility::string_t>  split_query(const utility::string_t &query);
...
#pragma region validation
    ...
    _ASYNCRTIMP static bool  validate(const utility::string_t &uri_string);
